...
- **Immersion Mode**: A master toggle (disabled by default) that synchronizes weather, lighting, and smooth animations. Managed via `isImmersionMode` in `GameContext.tsx`.
