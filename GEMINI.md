...
- **Immersion Mode**: A master toggle (disabled by default) that synchronizes weather, lighting, 3D scroll effects, and smooth animations. Managed via `isImmersionMode` in `GameContext.tsx`.
