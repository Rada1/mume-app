...
import { Settings2, Plus, Grid, Layout } from 'lucide-react';
...
const ButtonSettings: React.FC<ButtonSettingsProps> = ({
    ...
    return (
        <div className="settings-section">
            ...
            {!isEditMode && (
                <div style={{ padding: '20px', textAlign: 'center', border: '1px dashed var(--border-modal)', borderRadius: '8px', opacity: 0.6 }}>
