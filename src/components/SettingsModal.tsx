        ...
        <div className="modal-overlay" onClick={() => setIsSettingsOpen(false)}>
            <div className="modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-tabs">
                    ...
                    <div className={`modal-tab ${settingsTab === 'actions' ? 'active' : ''}`} onClick={() => setSettingsTab('actions')}>Actions</div>
                </div>
                    ...
                    {settingsTab === 'actions' && (
                        <>
                            <div className="setting-group" style={{ border: '1px solid rgba(16, 185, 129, 0.3)', background: 'rgba(16, 185, 129, 0.05)', padding: '15px', borderRadius: '8px', marginBottom: '20px' }}>
                                <label className="setting-label" style={{ color: '#34d399', fontWeight: 'bold' }}>Add New Action</label>
                                <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginBottom: '10px' }}>Fire commands when incoming text matches a pattern.</div>
                            ...
                            <div style={{ marginTop: '20px' }}>
                                ...
                                {!actions?.length && <span className="text-gray-500 italic">No actions defined yet.</span>}
                                {actions?.map(a => (
