...
export const COMMUNICATION_BUTTONS: CustomButton[] = [
    ...
    { "id": "comm-social", "label": "Social", "command": "social list", "setId": "communicate", "actionType": "menu", "display": "floating", "style": { "x": 0, "y": 0, "w": 90, "h": 40, "backgroundColor": "#06b6d4", "shape": "pill" }, "trigger": { "enabled": false, "pattern": "", "isRegex": false, "autoHide": false, "duration": 0 }, "isVisible": true }
];
