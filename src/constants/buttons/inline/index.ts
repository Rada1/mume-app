...
export const CATEGORY_BUTTON_MAP: Record<string, string[]> = {
    ...
    'inline-ally': ['inlp-group', 'inlp-follow', 'inlp-soc', 'inlp-conv', 'inlp-whois', 'inlp-ex', 'inlp-consider'],
    'inline-enemy': ['inlp-kill', 'inlp-track', 'inlp-whois', 'inlp-ex', 'inlp-consider'],
    'inline-neutral': ['inlp-neutral-soc', 'inlp-neutral-conv', 'inlp-whois', 'inlp-ex', 'inlp-consider'],
