...
export const THIEF_SKILLS: CustomButton[] = [
    {
        ...
        "display": "floating",
        "hideIfUnknown": true,
        "style": { "x": 85, "y": 60, "w": 80, "h": 40, "backgroundColor": "rgba(55, 65, 81, 0.5)", "transparent": true, "shape": "pill", "iconScale": 1.4 },
    ...
    },
    {
        ...
        "display": "floating",
        "hideIfUnknown": true,
        "style": { "x": 75, "y": 60, "w": 80, "h": 40, "backgroundColor": "rgba(55, 65, 81, 0.5)", "transparent": true, "shape": "pill", "iconScale": 1.4 },
        "trigger": { "enabled": false, "pattern": "", "isRegex": false, "autoHide": false, "duration": 0, "type": "show" },
        "isVisible": true
    },
    {
        ...
        "display": "floating",
        "hideIfUnknown": true,
        "style": { "x": 65, "y": 60, "w": 80, "h": 40, "backgroundColor": "rgba(55, 65, 81, 0.5)", "transparent": true, "shape": "pill", "iconScale": 1.4 },
        "trigger": { "enabled": false, "pattern": "", "isRegex": false, "autoHide": false, "duration": 0, "type": "show" },
        "isVisible": true
    },
    {
        ...
        "display": "floating",
        "hideIfUnknown": true,
        "style": { "x": 55, "y": 60, "w": 80, "h": 40, "backgroundColor": "rgba(55, 65, 81, 0.5)", "transparent": true, "shape": "pill", "iconScale": 1.4 },
        "trigger": { "enabled": false, "pattern": "", "isRegex": false, "autoHide": false, "duration": 0, "type": "show" },
        "isVisible": true
    },
    {
