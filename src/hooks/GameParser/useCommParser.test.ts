...
describe('useCommParser - XML comm requirement', () => {
    ...
    it('preserves the ANSI colors in tell bodies', () => {
        const { result } = renderHook(() => useCommParser(createDeps()));
        ...
        expect(parsed.commText).toBe("\x1b[37m'I've been attached since 2007ish but back for longer than a \x1b[92mweek since 2012ish :)'");
