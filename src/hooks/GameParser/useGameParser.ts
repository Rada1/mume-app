...
export function useGameParser(deps: UseGameParserDeps, session: SessionContextType) {
    ...
    const {
        ...
        playerPosition, inlineCategories, roomPlayers,
    ...
    const { routeMessage, determineVisibility, detectItemsInRoom } = useMessageRouter({
        ...
        setWhoList, setWhereList, setRoomItems: sessionSetRoomItems, registerEntity, setCharacterInfo, setDiscoveredItems, extractNoun, ansiConvert,
