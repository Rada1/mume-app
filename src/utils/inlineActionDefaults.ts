...
export const DEFAULT_CATEGORY_CONFIGS: CategoryConfig[] = [
    ...
    { id: 'cat-ally', label: 'Ally', color: '#55a5e2', isGmcpCategory: true, legacyIds: ['inline-ally', 'player', 'ally'], defaultTraitIds: ['trait-group', 'trait-social', 'trait-identify', 'trait-examine', 'trait-consider'] },
    ...
    { id: 'cat-container-item', label: 'Container Item', isLocationCategory: true, legacyIds: ['inline-container-item'], defaultTraitIds: ['trait-get-container-item'] },
