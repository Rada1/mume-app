    ...
    private handleNegotiation(option: number) {
        ...
        if (cmd === DO && option === TELNET_TTYPE) {
            ...
            if (!this.gmcpReady) {
                ...
                this.options.sendGMCP('Core.Supports.Set', [
                    "Core 1", "Char 1", "Char.Vitals 1", "Char.Ride 1", "Group 1", 
                    "Room 1", "Room.Info 1", "Room.UpdateExits 1", "Room.Players 1", "Room.NPCs 1", "Room.Chars 1", "Room.Items 1", "Char.Items 1", "Comm 1", "External.Room 1", 
                    "Mume.Client 1", "Mume.Client.Chars 1", "Mume.Client.Items 1", "Mume.Client.Error 1"
                ]);
            }
