...
function finish() {
    ...
    let mdContent = '# MUME Shaper Mode /com Command Help Guides\n\n';
    mdContent += 'This guide contains locally stored MUME building help pages for `/com` reset command trees, retrieved directly from the live game server.\n\n';
    ...
    for (const cmd of helpCommands) {
        ...
        const lines = text.split('\n')
            ...
            .filter(line => !line.includes('ellessar>') && !line.includes('15019[') && !line.includes('/help com'));
    ...
    const outputFilePath = path.join('c:/Users/pwetz/Downloads/mume app/docs', 'com_help.md');
