...
function finish() {
    ...
    let mdContent = '# MUME Shaper Mode /lib Command Help Guides\n\n';
    mdContent += 'This guide contains locally stored MUME building help pages for `/lib` behaviour definitions, retrieved directly from the live game server.\n\n';
    ...
    for (const cmd of helpCommands) {
        ...
        const lines = text.split('\n')
            ...
            .filter(line => !line.includes('ellessar>') && !line.includes('15019[') && !line.includes('/help lib'));
    ...
    const outputFilePath = path.join('c:/Users/pwetz/Downloads/mume app/docs', 'lib_help.md');
